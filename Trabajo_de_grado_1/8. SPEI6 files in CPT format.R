...
setwd("D:\\OneDrive - CGIAR\\CIAT\\[] MAESTRIA\\TRABAJO DE GRADO_1\\DATA\\SPEI\\SPEI_6_months\\")
...
plot(allrasters.SPEI[[514]])

date=seq(as.Date("1981-06-01"),as.Date("2024-03-31") ,by="month")
...
year_month = seq(as.Date("1981-06-01"),as.Date("2024-03-31") ,by="month")
...
name_file="EJE_CAF_CPT_SPEI6.txt"
sink(name_file)
cat(p)
cat("\n")
cat(p1) 
